...
internal sealed class VirtualProjectBuildingCommand : CommandBase
{
    ...
    public DotNetProject CreateVirtualProject(DotNetProjectEvaluator evaluator)
    {
        return CreateVirtualProject(evaluator, addGlobalProperties: null);
    }
        ...
        Action<IDictionary<string, string>>? addGlobalProperties)
    {
        ...
        var directives = FileLevelDirectiveHelpers.EvaluateDirectives(project.Instance(), Directives, EntryPointSourceFile, DiagnosticBag.ThrowOnFirst());
